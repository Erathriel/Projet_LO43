...
public class PileCarteModele {
    ...
    public void remplissage(){
        /*Si il manque d'un certain type de carte dans la pioche alors cela la remet a son etat d'origine avec tout les objets */
        int nbrcle=0;
        int nbrCarteEtu=0;
        int nbrOutil=0;
    ...
    public void setListeCarte(){
        /*Création de tout les objets de la pile de carte */
        try {
        ...
        }catch (IOException e){System.out.print("Erreur Reading file PileCarte");}
    }
